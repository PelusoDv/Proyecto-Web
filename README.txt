...
2. Primero que nada ejecutar el comando "npm i" para instalar dependencias 
(Este proyecto es de muestra y no esta "construido")
3. Luego ejecutar el comando "npm run start"
...
2. Escribir en el shell "use tienda_cafe" y dar enter.
